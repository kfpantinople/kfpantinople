...
public class SelfAwarenessPhlegmaticUI extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_self_awareness_phlegmatic_ui);
    ...
    public void buttonclick(View v)
    {
        ...
        saController.calculateresult(4,assigncb());
